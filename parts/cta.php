		...
		<?php if (get_theme_mod( 'unconditional_intro_text' )) { ?>
		    <p class="lead">
			    <?php //echo esc_html(get_theme_mod( 'unconditional_intro_text' )) ;?>
                        ...
                        <br>
                        <span class='subtitleheader' style='color:rgb(255, 66, 66);'>& Accounting Services, LLC </span>
                        
                   <span id='header-subtitle'>     
                    <span>
                        <br> Certified Public Accountants <br> 
                    </span> 
                     
                    
                    Fast Refunds, Low price and Efficient Services!
                   </span>
